...
const PluginName := "ReBlocks"
const MainPanelScene := preload("res://addons/reblocks/ui/main_panel.tscn")
...
const BlockInspectorPlugin := preload("res://addons/reblocks/inspector_plugin/block_script_inspector.gd")
var block_inspector_plugin: BlockInspectorPlugin

const BlockTranslationParserPlugin := preload("res://addons/reblocks/translation/parser.gd")
