...
2. Install the plugin through the Godot AssetLib searching for the name
   ...
   drag the `addons/reblocks/` directory into your project's
...
The gettext PO files are located in the `addons/reblocks/locale` directory.
...
1. If your project already has the BlockCode plugin installed:
    1. Ensure you have committed your project to Git, including the `addons/reblocks` directory.
    ...
    3. In the *FileSystem* sidebar, delete the `res://addons/reblocks` directory
2. Download
