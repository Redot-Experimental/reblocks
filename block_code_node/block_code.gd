@tool
@icon("res://addons/reblocks/block_code_node/block_code_node.svg")
...
func _enter_tree():
	...
	if block_script == null:
		var new_block_script: BlockScriptSerialization = load("res://addons/reblocks/serialization/default_block_script.tres").duplicate(true)
