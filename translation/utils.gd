...
const LOCALE_DIR_PATH := "res://addons/reblocks/locale"

## BlockCode POT file path
const POT_FILE_PATH := "res://addons/reblocks/locale/godot_block_coding.pot"
...
static func _add_pot_files_recursive(pot_files: PackedStringArray, path: String):
	...
	if not path.begins_with("res://addons/reblocks"):
...
static func update_pot_files():
	...
	_add_pot_files_recursive(pot_files, "res://addons/reblocks")
